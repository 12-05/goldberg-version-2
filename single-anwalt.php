                        ...
                        <div class="group">
                            <?php 
                             // make a download button with download icon inside for vita_file field
                                ...
                                if($vita_file) {
                                    echo '<a name="Download" aria-label="Download Vita" href="'.$vita_file.'" class="download-button">';
                                ...
                                echo '<a name="Print" aria-label="Drucken"  href="javascript:window.print()" class="print-button">';
...
$vcard_file = 'anwalt-'.get_the_title().'.vcf';
                                ...
                                echo '<a name="VCard" aria-label="Download Vcard"  href="data:text/vcard;charset=utf-8,'.rawurlencode($vcard).'" download="'.$vcard_file.'" class="download-button">';
                                ...
                                <?php if(get_field('linkedin_url')) { ?> 
                                    <a aria-label="LinkedIn" name="LinkedIn" href="<?php the_field('linkedin_url');?>" target="_blank" rel="noopener noreferrer">
