                        ...
                        <div class="group">
                            <?php 
                             // make a download button with download icon inside for vita_file field
                                ...
                                if($vita_file) {
                                    echo '<a name="Download" href="'.$vita_file.'" class="download-button">';
                                ...
                                echo '<a name="Print" href="javascript:window.print()" class="print-button">';
...
$vcard_file = 'anwalt-'.get_the_title().'.vcf';
                                ...
                                echo '<a name="VCard" href="data:text/vcard;charset=utf-8,'.rawurlencode($vcard).'" download="'.$vcard_file.'" class="download-button">';
