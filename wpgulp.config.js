...
const projectURL = "websitebuilder.test";
...
const styleDestination = "./assets/css/compiled/";
...
const jsVendorDestination = "./assets/js/compiled/";
...
const jsCustomDestination = "./assets/js/compiled/";
